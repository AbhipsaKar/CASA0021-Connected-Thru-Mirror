 ...
 * MIT Licensed.
 */
Module.register("MMM-TFL-Arrivals-Modified", {
	defaults: {
		//app_id: "",
		//app_key: "",
	...
	start: function() {
		...
		if (this.data.classes === "MMM-TFL-Arrivals-Modified") {
		...
		this.url = encodeURI(this.apiBase + this.config.naptanId + "/Arrivals");
		//this.url = "https://api.tfl.gov.uk/StopPoint/490006170S/arrivals";
	...
	getStyles: function() {
		return ["MMM-TFL-Arrivals-Modified.css", "font-awesome.css"];
	},
