...
Module.register("clock", {
	...
	getDom: function () {
		...
		// Style Wrappers
		dateWrapper.className = "date bright medium bold";
		timeWrapper.className = "time bright large bold";
		secondsWrapper.className = "seconds bright";
