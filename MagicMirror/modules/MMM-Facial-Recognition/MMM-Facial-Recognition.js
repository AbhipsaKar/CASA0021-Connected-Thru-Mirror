...
Module.register('MMM-Facial-Recognition',{
	...
	login_user: function () {
		...
		this.sendNotification("Profile", this.current_user);
		
	},
	logout_user: function () {

		this.sendNotification("CURRENT_PROFILE", this.config.defaultClass);
		this.sendNotification("Profile", this.config.defaultClass);
	...
	suspend: function() {
		Log.log('Module is stopped.');
		//this.sendSocketNotification('CONFIG_END', this.config);
	},
	
	resume: function(){
		Log.log('Module is started.');
		this.sendSocketNotification('CONFIG', this.config);
	},
