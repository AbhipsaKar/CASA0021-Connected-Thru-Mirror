...
(function () {
    ...
    Module.register('MMM-Carousel2', {
        ...
        notificationReceived: function (notification, payload, sender) {
           ...
           if (notification === "Joystick_action_right") {
               self.manualTransition(undefined, 1);
               this.restartTimer();
           }
           if (notification === "Joystick_action_left") {
               self.manualTransition(undefined, -1);
               this.restartTimer();
           }
        ...
        moduleTransition: function (goToIndex=-1, goDirection=0) {
            ...
            Log.info("Current page: " + this.currentIndex);
            self.sendNotification("CurrentPage", this.currentIndex);
        },
